...
//     cy.get('.popup').within(() => {
//       cy.get('h2')
//         .should('contain', 'Riddle')
//         .get('p')
//         .should('contain', 'We come from a place beyond')
//         .get('input')
//         .type('ahh')
//         .should('have.value', 'ahh')
//         .get('button')
//         .last()
//         .click();
//     });
...
//     cy.get('.popup').within(() => {
//       cy.get('h2')
//         .should('contain', 'The slap heard round the world.')
//         .get('p')
//         .should('contain', 'This actor is famous')
//         .get('input')
//         .type('ahh')
//         .should('have.value', 'ahh')
//         .get('button')
...
//     cy.get('.popup').within(() => {
//       cy.get('h2')
//         .should('contain', 'Some truths can only be found in the dark.')
//         .get('p')
//         .should('contain', 'Search the room.')
//         .get('input')
//         .type('ahh')
//         .should('have.value', 'ahh')
//         .get('button')
...
//     cy.get('.popup').within(() => {
//       cy.get('h2')
//         .should('contain', "Looks like Bob's been decoding a cipher")
//         .get('input')
//         .type('ahh')
//         .should('have.value', 'ahh')
//         .get('button')
...
//     cy.get('.popup').within(() => {
//       cy.get('h2')
//         .should('contain', 'Radio Frequency: Tune to the correct station.')
//         .get('p')
//         .should('contain', 'The first digit of the radio station')
//         .get('input')
//         .type('ahh')
//         .should('have.value', 'ahh')
//         .get('button')
...
//     cy.get('input')
//       .type('Grogu')
//       .should('have.value', 'Grogu')
//       .get('button')
//       .last()
//       .click();
//     cy.get('p')
//       .should('contain', 'Greetings Grogu')
//       .get('.see-message-btn')
//       .click();
...
//         .get('input')
//         .type('alpha centauri')
//         .should('have.value', 'alpha centauri')
//         .get('button')
//         .first()
//         .click();
//     });
